...
<link rel="stylesheet" href="http://jquerymobile.com/demos/1.1.0/docs/_assets/css/jqm-docs.css"/>
  ...
  <title><?php echo ($class["mc_title"]); ?></title>
...
<div class="knowlg-detail">
  <div class="knowlg-detail-header">
    <h2><?php echo ($class["mc_title"]); ?></h2>
    <div class="knowlg-detail-data clearfix">
      <div class="knowlg-time"><img style="width: 16px;" src="/yoga/Public/yoga/img/time.png" alt="">&nbsp;<span><?php echo ($class["mc_addtime"]); ?></span></div>
      <div class="knowlg-icon-wrapper">
        <div class="knowlg-view" ><img src="/yoga/Public/yoga/img/icon1.png" alt="">&nbsp;<span><?php echo ($class["mc_readnum"]); ?></span></div>
        <div class="knowlg-praise" id="agree"><img src="/yoga/Public/yoga/img/icon2.png" alt="">&nbsp;<span id="agnum"><?php echo ($class["mc_agreenum"]); ?></span></div>
        <div class="knowlg-like" id="save"><img src="/yoga/Public/yoga/img/icon3.png" alt="">&nbsp;<span id="sanum"><?php echo ($class["mc_savenum"]); ?></span></div>
      </div>
    </div>
  </div>
  <div class="knowlg-detail-body">
    <div class="knowlg-image-wrapper">
      <img src="/yoga/Public<?php echo ($class["mc_photo"]); ?>" alt="<?php echo ($class["mc_title"]); ?>">
    </div>
    <div class="detail-summary">
      <div class="detail-inner-wrapper">
      <div><img src="/yoga/Public/yoga/img/icon4.png" alt=""><span>日期：</span>&nbsp;<span><?php echo ($class["mc_starttime"]); ?>～<?php echo ($class["mc_stoptime"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
      <span>截止报名时间：</span>&nbsp;<span><?php echo ($class["mc_closingtime"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
      <span><?php if($class["mc_valid"] == 1): ?><span style="color:green;font-size:16px;font-weight:bold;">已结束</span><?php elseif($class["mc_valid"] == 2): ?><span style="color:green;font-size:16px;font-weight:bold;">进行中</span><?php else: ?><span style="color:#FFF000;font-size:16px;font-weight:bold;">预约中</span><?php endif; ?></div>
      <div><img style="width:18px;" src="/yoga/Public/yoga/img/icon5.png" alt=""><span>地点：</span>&nbsp;<span><?php echo ($class["mc_adress"]); ?></span></div>
      <div><img style="width:18px;" src="/yoga/Public/yoga/img/icon6.png" alt=""><span>老师：</span>&nbsp;<span><?php echo ($class["mc_teacher"]); ?></span><span style="margin-left: 15px;">义工：</span>&nbsp;<span><?php echo ($class["mc_worker"]); ?></span></div>
      <div><img src="/yoga/Public/yoga/img/icon7.png" alt=""><span>名额：</span>&nbsp;<span><?php echo ($class["mc_num"]); ?>/<?php if($class["mc_maxnum"] == 0): ?>不限<?php else: echo ($class["mc_maxnum"]); endif; ?></span></div>
      </div>
    </div>

    <div class="knowlg-detail-content">
        <p style="border:1px solid #DCDCDC;line-height:30px;padding-left:10px;padding-top:5px;padding-right:10px;padding-bottom:5px;"><span style="font-weight:bolder;">简介:</span><span style="color:#A9A9A9;"><?php echo ($class["mc_say"]); ?></span></p>
    ...
    <script type="text/javascript">
          var str="<?php echo ($class["news_content_body"]); ?>";
  ...
  <script type="text/javascript" src="/yoga/Public/yoga/js/jquery.qrcode.js"></script>
    ...
    $('#back').click(function(e) {
    	e.preventDefault();
    	 ...
    	 if(cookie=='1'){
    		 ...
    		 window.location.href="<?php echo U('Class/classload');?>";
   ...
   $('.webui-popover-content').qrcode({
 		...
 		$('.knowlg-detail-praise').click(function(e) {
 			e.preventDefault();
 			var $that = $(this);
 			$.post('<?php echo U("class/addagree");?>',
					  {id:<?php echo ($class["mc_id"]); ?>},
				function(data){
