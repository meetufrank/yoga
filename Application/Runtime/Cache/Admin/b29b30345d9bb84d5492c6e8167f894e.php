...
<script type="text/javascript" src="/yoga/Public/assets/js/region.js"></script>
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="form0" id="form0"  method="post" action="<?php echo U('class_runedit');?>"  enctype="multipart/form-data">
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-10">
										<input type="hidden" name="mc_id" value="<?php echo ($classdata['mc_id']); ?>"/>
											<input type="text" name="title" id="title"  value="<?php echo ($classdata["mc_title"]); ?>" class="col-xs-10 col-sm-6"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											 <select name="member_list_province" id="class_diyflag" onChange="loadClass('class_diyflag','class_type','<?php echo U('Ajax/getClass');?>');">
												...
												<?php if(is_array($diyflag_two)): foreach($diyflag_two as $key=>$dt): ?><option value="<?php echo ($dt["dt_value"]); ?>" <?php if($dt['dt_value'] == $classdata['ct_type_one']): ?>selected<?php endif; ?> ><?php echo ($dt["dt_name"]); ?></option><?php endforeach; endif; ?>
											 </select>
									...
									$(function() {
										loadClass('class_diyflag','class_type','<?php echo U('Ajax/getClass');?>',"<?php echo ($classdata['ct_id']); ?>");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
												<input type="text" name="news_flag" id="news_flag"  placeholder="必填：课程老师"  class="col-xs-10 col-sm-6" value="<?php echo ($classdata["mc_teacher"]); ?>"/>
                                             <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resone"></span>
											 </span>
											 </div>
                                    ...
                                    <div class="space-4"></div>
                                     ...
                                     <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 课程义工：  </label>
                                                  <div class="col-sm-5">
												<input type="text" name="work_flag" id="work_flag"  placeholder="必填：课程义工"  class="col-xs-10 col-sm-6" value="<?php echo ($classdata["mc_worker"]); ?>"/>
                                             <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="resone"></span>
											 </span>
											 </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="mc_name" id="person" value="<?php echo ($classdata["mc_person"]); ?>" class="col-xs-10 col-sm-6" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="tel" id="tel" value="<?php echo ($classdata["mc_tel"]); ?>" class="col-xs-10 col-sm-6" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 地址类型 ： </label>
												<div class="checkbox">
													...
													<label id="">
														<input class="ace ace-radio-2" name="sea" type="radio"  value="0" <?php if($classdata["mc_sea"] == 0): ?>checked="checked"<?php endif; ?>/>
														<span class="lbl"> 境内</span>
													</label>
													<label id="">
														<input class="ace ace-radio-2" name="sea" type="radio"  value="1" <?php if($classdata["mc_sea"] == 1): ?>checked="checked"<?php endif; ?>/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="city" id="city"  class="col-xs-3 col-sm-2"  value="<?php echo ($classdata["mc_city"]); ?>"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="adress" id="adress" value="<?php echo ($classdata["mc_adress"]); ?>" class="col-xs-10 col-sm-6" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="starttime" id="starttime" value="<?php echo ($classdata["mc_starttime"]); ?>" class="col-xs-2 col-sm-2" />
											<div class="col-xs-1" style="text-align:center;line-height:30px;font-size:30px;">-</div>
											<input type="text" name="stoptime" id="stoptime" value="<?php echo ($classdata["mc_stoptime"]); ?>" class="col-xs-2 col-sm-2" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="closingtime" id="closingtime" value="<?php echo ($classdata["mc_closingtime"]); ?>" class="col-xs-2 col-sm-2" />
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 课程最大报名数限制：  </label>
										<div class="col-sm-10">
											<input type="text" name="maxnum" id="max" value="<?php echo ($classdata["mc_maxnum"]); ?>" class="col-xs-3 col-sm-1" />
									...
									<div class="form-group">
										...
										<a href="javascript:;" class="file">
                                          <input type="file" name="pic_one[]" id="file0" />
											...
											<span class="lbl">&nbsp;&nbsp;<img <?php if($classdata.mc_photo): ?>src="/yoga/Public<?php echo ($classdata["mc_photo"]); ?>"<?php else: ?> src="/yoga/Public/img/no_img.jpg"<?php endif; ?> width="100" height="70" id="img0" ></span>&nbsp;&nbsp;<a href="javascript:;" onClick="return backpic('/yoga/Public/img/no_img.jpg');" title="还原修改前的图片" class="file">
                                            撤销修改
										</a>
    ...
    <script src="/yoga/Public/ppy/js/fileinput_locale_zh.js" type="text/javascript"></script>
									...
									<div class="form-group">
										...
										<div class="col-sm-10" style="padding-top:5px;">
                                            <input name="open" id="open" value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" <?php if($classdata["mc_open"] == 1): ?>checked="checked"<?php endif; ?>/>
											<span class="lbl">&nbsp;&nbsp;</span>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10" style="padding-top:5px;">
                                            <input name="top" id="top" value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" <?php if($classdata["mc_top"] == 1): ?>checked="checked"<?php endif; ?>/>
											<span class="lbl">&nbsp;&nbsp;</span>
										</div>
									</div>
                                    <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="hidden" name="mc_content" value="<?php echo ($classdata["mc_content"]); ?>"/>
											<input type="text" name="say" id="news_scontent" class="col-xs-10 col-sm-10"  maxlength="50" value="<?php echo ($classdata["mc_say"]); ?>" />
