...
.morecss{
  ...
  <script>
     $(function(){
       <?php
 if($_GET){ echo 'var obj='.json_encode($_REQUEST).';'; } ?>
	...
	<div id="app">
	<form id="filterForm" name="form1" method="get" action="<?php echo U('Class/classshow');?>">
      ...
      <input id="type" type="hidden" value="" name="type" to="filter">
		...
		<div class="course-filter-wrapper">
			<div class="course-filter-header clearfix">
				...
				<div class="course-filter-item"> <a href="javascript:showchild('places')"><span class="f-text">地点</span><span class="course-caret"></span></a> </div>
				<div class="course-filter-item"> <a href="javascript:showchild('persons')"><span class="f-text">人群</span><span class="course-caret"></span></a> </div>
			</div>
			<div class="course-filter-body clearfix" >
				...
				<div class="course-filter-inner course-filter-inner-left" id="alltype" style="display:none;">
				    ...
				    <?php if(is_array($typedata)): foreach($typedata as $key=>$ty): ?><div class="course-filter-body-item"><a  type="<?php echo ($ty["ct_id"]); ?>" href="javascript:Filter('type','<?php echo ($ty["ct_id"]); ?>');"><?php echo ($ty["ct_name"]); ?></a></div><?php endforeach; endif; ?>
                </div>
		...
		<div class="p-course-filter-wrapper">
			...
			<div class="p-course-inner-filter clearfix">
				<div class="panel-group" id="father">
					...
					<div class="panel panel-default">
						<div class="panel-heading clearfix" style="background:#fff;">
							<div class="p-single-filter-item pull-left" style="width:98%; height:24px; overflow:hidden;">
							...
							<h4 class="panel-title pull-right" style="width:2%;">
						...
						<div class="panel-collapse collapse" id="second">
							<div class="panel-body" style="padding:0px 15px 10px 15px; border-top: none;">
								<div class="row">
						...
						<div class="">
							<div class="panel-heading clearfix" id="hoverall">
								<div id="myTab" class="p-single-filter-item pull-left">
									...
									<a href="#crowd-tabs-2" role="tab" data-toggle="tab">儿童/青少年</a>
									<a href="#crowd-tabs-3" role="tab" data-toggle="tab">成人</a>
									<a href="#crowd-tabs-4" role="tab" data-toggle="tab">企业</a>
								</div>
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="crowd-tabs-1">
									<div class="panel-heading clearfix">
										<div class="p-single-filter-item pull-left" style="width:98%; height:24px; ">
											<div class="p-single-filter-title">类型 </div>
											<a  type="all" href="javascript:Filter('type','all');" class="active">全部</a>
									...
									<div class="panel-collapse collapse" id="forth">
										<div class="panel-body" style="padding:0px 15px 10px 15px; border-top: none; ">
											<div class="row">
												<div style="margin-left: 60px;">
													<div class="p-single-filter-item">
														<a href="#">志愿者培训课程</a><a href="#"> 企业课程</a><a href="#">志愿者培训课程</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div role="tabpanel" class="tab-pane" id="crowd-tabs-2">
									<div class="panel-heading clearfix">
										<div class="p-single-filter-item pull-left" style="width:98%; height:24px; overflow:hidden;">
											<div class="p-single-filter-title">类型 </div>
											<a class="active" href="#">全部</a>
											<a href="#">儿童课程</a><a href="#">青少年课程</a>
										</div>
										<!-- <h4 class="panel-title pull-right" style="width:2%;">
											<a href="#forth" data-toggle="collapse" data-parent="#father">
												<span class="glyphicon glyphicon-chevron-down pull-right"></span>
								...
								<div role="tabpanel" class="tab-pane" id="crowd-tabs-3">
									<div class="panel-heading clearfix">
										<div class="p-single-filter-item pull-left" style="width:98%; height:24px;">
											<div class="p-single-filter-title">类型 </div>
											<a class="active" href="#">全部</a>
											...
											<a href="#">阿育吠陀烹饪课程</a>
											<a href="#">高级课</a><a href="#">突破个人极限</a><a href="#">预备师资课</a>
											<a href="#">祝福课</a><a href="#">前世今生</a><a href="#">志愿者培训课程</a><a href="#"> 企业课程</a>
										</div>
										<h4 class="panel-title pull-right" style="width:2%;">
											<a href="#fifth" data-toggle="collapse" data-parent="#father">
												<span class="glyphicon glyphicon-chevron-down pull-right"></span>
											</a>
										 </h4>
									</div>
								...
								<div role="tabpanel" class="tab-pane" id="crowd-tabs-4">
									<div class="panel-heading clearfix">
										<div class="p-single-filter-item pull-left" style="width:98%; height:24px; overflow:hidden;">
											<div class="p-single-filter-title">类型 </div>
											<a class="active" href="#">全部</a>
											<a href="#"> 企业课程</a><a href="#"> 企业领导课程</a>
										</div>
										<!-- <h4 class="panel-title pull-right" style="width:2%;">
											<a href="#forth" data-toggle="collapse" data-parent="#father">
												<span class="glyphicon glyphicon-chevron-down pull-right"></span>
  ...
  <script>
    $(function () {
     ...
     $("#getmore").click(function(){
  	   ...
  	   $.ajax({
     		type:'post',
     		url:"<?php echo U('Class/classshow');?>",
