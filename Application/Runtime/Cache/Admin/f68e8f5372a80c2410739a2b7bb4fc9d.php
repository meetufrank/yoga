...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/yoga/index.php/Admin/News/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
...
<script type="text/javascript" src="/yoga/Public/assets/js/region.js"></script>
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="form0" id="form0"  method="post" action="<?php echo U('class_register_runedit');?>"  enctype="multipart/form-data">
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-10">
										<input type="hidden" name="cr_id" value="<?php echo ($ac_re["cr_id"]); ?>"/>
										<input type="hidden" name="mc_id" value="<?php echo ($ac_re["cr_classid"]); ?>"/>
											<input type="text" name="name" id="name"  placeholder=""  class="col-xs-10 col-sm-1" value="<?php echo ($ac_re["cr_name"]); ?>"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="tel" id="tel"  placeholder=""  class="col-xs-10 col-sm-3" value="<?php echo ($ac_re["cr_tel"]); ?>" />
                                    ...
                                    <div class="space-4"></div>
                                    <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 国家（护照）：  </label>
										<div class="col-sm-10">
											<input type="text" name="country" id="country"  placeholder=""  class="col-xs-10 col-sm-1" value="<?php echo ($ac_re["cr_country"]); ?>"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="address" id="address"  placeholder=""  class="col-xs-10 col-sm-3" value="<?php echo ($ac_re["cr_address"]); ?>" />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="birthday" id="birthday"  placeholder="2016-05-30"  class="col-xs-10 col-sm-2" value="<?php echo ($ac_re["cr_birthday"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											 <select name="sex"  class="knows_type">
												...
												<option value="0" <?php if($ac_re['cr_sex'] == 0): ?>selected<?php endif; ?>>女</option>
											 </select>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="more" id="more"  placeholder="若无参加则为空"  class="col-xs-10 col-sm-2" value="<?php echo ($ac_re["cr_more"]); ?>"/>
                                    ...
                                    <div class="space-4"></div>
                                     <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 有无疾病及疾病名称：  </label>
										<div class="col-sm-10">
											<input type="text" name="health" id="health"  placeholder="若无则为空"  class="col-xs-10 col-sm-2" value="<?php echo ($ac_re["cr_health"]); ?>"/>
                                    ...
                                    <div class="space-4"></div>
                                     <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 药品需求：  </label>
										<div class="col-sm-10">
											<input type="text" name="drug" id="drug"  placeholder="若无则为空"  class="col-xs-10 col-sm-2" value="<?php echo ($ac_re["cr_drug"]); ?>"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="email" id="email"  placeholder="例：972270516@qq.com"  class="col-xs-10 col-sm-2" value="<?php echo ($ac_re["cr_email"]); ?>" />
    ...
    <script src="/yoga/Public/ppy/js/fileinput_locale_zh.js" type="text/javascript"></script>
									...
									<div class="form-group">
										...
										<div class="col-sm-10" style="padding-top:5px;">
                                            <input name="open" id="open" value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" <?php if($ac_re['cr_open'] == 1): ?>checked<?php endif; ?> />
											<span class="lbl">&nbsp;&nbsp;注意：课程报名需要开启用户才能看到发布信息</span>
										</div>
									</div>
...
$(function(){
	...
	function checkForm(){
		...
		if( '' == $.trim($('#country').val())){
			layer.alert('国家不能为空', {icon: 6}, function(index){
 			layer.close(index);
			$('#country').focus();
			});
			return false;
		...
		if( '' == $.trim($('#address').val())){
			layer.alert('地址不能为空', {icon: 6}, function(index){
 			layer.close(index);
			$('#address').focus();
			});
			return false;
