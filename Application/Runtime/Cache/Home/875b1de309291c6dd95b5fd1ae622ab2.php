...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="/yoga/Public/yoga/js/jquery.webui-popover.min.css">
  ...
  <title><?php echo ($knows["ms_title"]); ?></title>
...
<div class="knowlg-detail">
  <div class="knowlg-detail-header">
    <h2><?php echo ($knows["ms_title"]); ?></h2>
    <div class="knowlg-detail-data clearfix">
      <div class="knowlg-time"><img style="width: 16px;" src="/yoga/Public/yoga/img/time.png" alt="">&nbsp;<span><?php echo ($knows["ms_addtime"]); ?></span></div>
      <div class="knowlg-icon-wrapper">
        <div class="knowlg-view" ><img src="/yoga/Public/yoga/img/icon1.png" alt="">&nbsp;<span><?php echo ($knows["ms_readnum"]); ?></span></div>
        <div class="knowlg-praise" id="agree"><img src="/yoga/Public/yoga/img/icon2.png" alt="">&nbsp;<span id="agnum"><?php echo ($knows["ms_agreenum"]); ?></span></div>
        <div class="knowlg-like" id="save"><img src="/yoga/Public/yoga/img/icon3.png" alt="">&nbsp;<span id="sanum"><?php echo ($knows["ms_savenum"]); ?></span></div>
      </div>
    </div>
  </div>
  <div class="knowlg-detail-body">
    <div class="knowlg-image-wrapper">
      <img src="/yoga/Public<?php echo ($knows["ms_photo"]); ?>" alt="<?php echo ($knows["ms_title"]); ?>">
    </div>


    <div class="knowlg-detail-content">
       <p style="border:1px solid #DCDCDC;line-height:30px;padding-left:10px;padding-top:5px;padding-right:10px;padding-bottom:5px;"><span style="font-weight:bolder;">简介:</span><span style="color:#A9A9A9;"><?php echo ($knows["ms_say"]); ?></span></p>
        <div class="ms_content"></div>
    </div>
    ...
    <script type="text/javascript">
          var str="<?php echo ($knows["ms_content"]); ?>";


          $(".ms_content").html( UE.utils.html( str ) );
      </script>
  ...
  <script type="text/javascript" src="/yoga/Public/yoga/js/jquery.qrcode.js"></script>
   ...
   <script type="text/javascript" src="/yoga/Public/yoga/js/jquery.webui-popover.min.js"></script>
    ...
    $('#back').click(function(e) {
    	e.preventDefault();
    	 var cookie=$.cookie('knows_back');
    	 if(cookie=='1'){
    		 $.cookie('knows_back', null);
    		 window.location.href="<?php echo U('Knows/knowsload');?>";
 ...
 var $hidden_image_container = $('.hidden-image-container');
   ...
   $('.webui-popover-content').qrcode({
 		...
 		$('.knowlg-detail-praise').click(function(e) {
 			e.preventDefault();
 			var $that = $(this);
 			$.post('<?php echo U("knows/addagree");?>',
					  {id:<?php echo ($knows["ms_id"]); ?>},
				function(data){
...
var realWidth=$(".ms_content img").attr("width");   //图片实际宽度
  var realHeight=$('.ms_content img').attr("height");

   $('.ms_content img').each(function(){ //jquery.each()循环读取所有图片
