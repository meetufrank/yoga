 ...
 */
    public function plug_ad_list(){
    	...
    	$plug_ad_list=M('plug_ad')->table('__PLUG_AD__ pa')->join('__PLUG_ADTYPE__ pd on pd.plug_adtype_id=pa.plug_ad_adtypeid')->where($map)->limit($Page->firstRow.','.$Page->listRows)->order('plug_ad_order')->select();
