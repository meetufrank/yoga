	...
	<select name="opentype_time">
	  ...
	  <option value="2" <?php if($opentype_time == 2): ?>selected<?php endif; ?>>未过期</option>
		...
		<div class="hidden-sm hidden-xs action-buttons">
			<a class="green" href="<?php echo U('news_list_edit',array('ad_id'=>$v['ad_id']));?>" title="修改">
				<i class="ace-icon fa fa-pencil bigger-130"></i>
			</a>
			<a class="red" href="javascript:;" onclick="return del(<?php echo ($v["ad_id"]); ?>,<?php echo I('p',1);?>);" title="回收站">
			...
			<a  href="<?php echo U('News/save_copy',array('id'=>$v['ad_id'],'num'=>1));?>"  title="复制此内容" >
...
function del(id,p){
	    ...
	    layer.close(index);
	    window.location.href="/yoga/Admin/News/news_list_del/ad_id/"+id+"/p/"+p+"";//重新获取当前页面，删除后返回当前页码
	});
}
