	...
	function complete(data){
		if(data.status==1){
			...
			return false;
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="admin_list_edit" id="admin_list_edit" method="post" action="/yoga/Admin/Sys/admin_list_runedit">
								<input name="admin_id" id="admin_id" type="hidden" value="<?php echo ($admin_list["admin_id"]); ?>" />
                                    ...
                                    <div class="space-4"></div>
                                  <?php if($status == ""): ?><div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 当前状态： </label>
										<div class="col-sm-10" style="padding-top:5px;">
											...
											<span class="lbl">&nbsp;&nbsp;默认关闭,关闭则会导致该管理员无法登陆后台管理系统</span>
										</div>
									</div>
...
<![endif]-->
		...
		<script type="text/javascript">
    		...
    		<!--下拉样式以及JS-->
		<link rel="stylesheet" href="/yoga/Public/assets/css/chosen.css" />
		<script src="/yoga/Public/assets/js/chosen.jquery.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				if(!ace.vars['touch']) {
