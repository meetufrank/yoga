			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="excel_runimport" id="excel_runimport" method="post" action="<?php echo U('excel_runimport');?>"  enctype="multipart/form-data">
                                	<div class="form-group">
										...
										<div class="col-sm-4">
											...
											选择上传文件
												...
												<span style="float:right; line-height:35px; top:2px;"><a href="/yoga/Public/Excel/sample/mr_news.xls" target="_blank">下载示例表格</a></span>
