			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="member_list_edit" id="member_list_edit" method="post" action="/yoga/Admin/Member/member_list_runedit">
								<input type="hidden" name="member_list_id" id="member_list_id" value="<?php echo ($member_list_edit["member_list_id"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="member_list_username" id="member_list_username" value="<?php echo ($member_list_edit["member_list_username"]); ?>" placeholder="输入登录用户名" class="col-xs-10 col-sm-4" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="member_list_pwd" id="member_list_pwd" placeholder="输入登录密码" class="col-xs-10 col-sm-4" value="<?php echo ($member_list_edit["member_list_pwd"]); ?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="member_list_petname" id="member_list_petname" value="<?php echo ($member_list_edit["member_list_petname"]); ?>"  placeholder="输入昵称" class="col-xs-10 col-sm-4" />
										</div>
									</div>
                                    <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											 <select name="member_list_province" id="province" onChange="loadcity('province','city','<?php echo U('Ajax/getcity');?>');">
												...
												<?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["provinceid"]); ?>" <?php if($member_list_edit['member_list_province'] == $vo['provinceid']): ?>selected<?php endif; ?>><?php echo ($vo["provincename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											 </select>
											 <select name="member_list_city" id="city" >
											  <option  value="0">市/县</option>

											 <?php $city=M('city')->where(array('pid'=>$member_list_edit['member_list_province']))->select(); ?>
											 <?php if(is_array($city)): foreach($city as $key=>$v): ?><option <?php if($member_list_edit['member_list_city'] == $v['id']): ?>selected<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php echo ($v["cityname"]); ?></option><?php endforeach; endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<label>
												<input name="member_list_sex" <?php if($member_list_edit['member_list_sex'] == 0): ?>checked<?php endif; ?> type="radio" value="0" class="ace" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="member_list_tel" id="member_list_tel" value="<?php echo ($member_list_edit["member_list_tel"]); ?>"  placeholder="输入手机号码" class="col-xs-10 col-sm-4" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="email" name="member_list_email" id="member_list_email" value="<?php echo ($member_list_edit["member_list_email"]); ?>"  placeholder="输入联系邮箱" class="col-xs-10 col-sm-4" />
...
$(function(){
	...
	function checkForm(){
		...
		if( $.trim($('#member_list_pwd').val()).length > 0 && $.trim($('#member_list_pwd').val()).length < 6 || $.trim($('#member_list_pwd').val()).length >15 ){
