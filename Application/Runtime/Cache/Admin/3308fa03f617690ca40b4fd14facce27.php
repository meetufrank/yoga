      ...
      <script type="text/javascript" src="/yoga/Public/sldate/daterangepicker.js"></script>
               ...
               $(document).ready(function() {
                  $('#reservation').daterangepicker(null, function(start, end, label) {
					...
					<form name="admin_list_sea" class="form-search form-horizontal" method="post" action="/yoga/Admin/News/class_list">
							<div class="row maintop">
<div class="col-xs-12 col-sm-3 clo-md-3">
	...
	<select name="opentype_time">
	  ...
	  <option value="3" <?php if($opentype_time == 3): ?>selected<?php endif; ?>>预约中</option>
								...
								<div class="col-xs-12 col-sm-2 col-md-3 hidden-xs btn-sespan">
							...
							<div class="col-xs-12 col-sm-5 col-md-5 btn-sespan">
								<div class="col-xs-12 col-sm-4 col-md-6 col-lg-4">
									<select name="keytype" style="padding:0px;width:80px;height:30px;">
										...
										<option value="mc_city" <?php if($keytype == 'mc_city'): ?>selected<?php endif; ?>>按隶属城市</option>
									</select>
								</div>
								<div class="input-group col-sm-8 col-md-6 col-lg-8">
									<!--<span class="input-group-addon">
							  ...
							  <div class="input-group-btn col-sm-2 col-md-1">
								<a href="/yoga/Admin/News/class_list">
							...
							<div class="row">
							    <div class="col-xs-12">
										<div>
                                        <form id="alldel" name="alldel" method="post" action="<?php echo U('class_list_alldel');?>" >
		...
		<div class="hidden-sm hidden-xs action-buttons">
			<a class="green" href="<?php echo U('class_list_edit',array('mc_id'=>$v['mc_id']));?>" title="修改">
				<i class="ace-icon fa fa-pencil bigger-130"></i>
			</a>
			<a class="red" href="javascript:;" onclick="return del(<?php echo ($v["mc_id"]); ?>,<?php echo I('p',1);?>);" title="回收站">
			...
			<a  href="<?php echo U('News/save_copy',array('id'=>$v['mc_id'],'num'=>2));?>"  title="复制此内容" >
...
function del(id,p){
	    ...
	    layer.close(index);
	    window.location.href="/yoga/Admin/News/class_list_del/mc_id/"+id+"/p/"+p+"";//重新获取当前页面，删除后返回当前页码
	});
}
