						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="form0" id="form0"  method="post" action="<?php echo U('news_runadd');?>"  enctype="multipart/form-data">
                                       ...
                                       <?php $arr=session('activecopy');?>
									<div class="space-4"></div>

                                	<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 活动名称：  </label>
										<div class="col-sm-10">
											<input type="text" name="title" id="title"  placeholder="必填：活动标题"  class="col-xs-10 col-sm-6" value="<?php echo ($arr["ad_title"]); ?>"/>
										...
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 活动适用人群：  </label>
                                                ...
                                                <?php if(is_array($diyflag)): foreach($diyflag as $key=>$diyflag): ?><label id="news_flag_<?php echo ($diyflag["diyflag_value"]); ?>">
													<?php $var = $diyflag["diyflag_value"]; ?>
														<input class="ace ace-checkbox-2 news_flag" name="news_flag[]" type="checkbox" id="news_flag_va<?php echo ($diyflag["diyflag_value"]); ?>" value="<?php echo ($diyflag["diyflag_value"]); ?>" <?php if(in_array(($var), is_array($arr["ad_type"])?$arr["ad_type"]:explode(',',$arr["ad_type"]))): ?>checked="checked"<?php endif; ?> />
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="adress" id="adress" placeholder="例：浦东新区xxx路xxx号等" class="col-xs-10 col-sm-6"  />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
    ...
    <script src="/yoga/Public/ppy/js/fileinput_locale_zh.js" type="text/javascript"></script>
									...
									<div class="form-group">
										...
										<div class="col-sm-10" style="padding-top:5px;">
                                            <input name="open" id="open" value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" <?php if($arr["ad_open"] == 1): ?>checked="checked"<?php endif; ?> />
											<span class="lbl">&nbsp;&nbsp;注意：活动需要开启用户才能看到发布信息</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="say" id="news_scontent" class="col-xs-10 col-sm-10"  maxlength="50" value="<?php echo ($arr["ad_say"]); ?>"/>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="submit" id="kaopu">
...
$(function(){
	...
	function checkForm(){
		...
		if( '' == $.trim($('#file0').val())){
			layer.alert('你必须上传一个活动封面', {icon: 6}, function(index){
 			layer.close(index);
			$('#file0').focus();
			});
			return false;
