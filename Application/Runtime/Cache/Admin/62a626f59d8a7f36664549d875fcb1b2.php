...
<form class="form-horizontal" name="source_add" id="source_add" method="post" action="/yoga/index.php/Admin/Sys/source_runadd">
...
<form class="form-horizontal" name="source_runedit" id="source_runedit" method="post" action="/yoga/index.php/Admin/Sys/source_runedit">
...
function del(id,p){
	...
	layer.close(index);
	window.location.href="/yoga/index.php/Admin/Sys/source_del/source_id/"+id+"/p/"+p+"";
	});
}
