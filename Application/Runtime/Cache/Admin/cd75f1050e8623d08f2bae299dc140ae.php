...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/slackck_0530/index.php/Admin/We/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
...
<form class="form-horizontal" name="we_menu_runadd" id="we_menu_runadd" method="post" action="/slackck_0530/index.php/Admin/We/we_menu_runadd">
...
<form class="form-horizontal" name="we_menu_runedit" id="we_menu_runedit" method="post" action="/slackck_0530/index.php/Admin/We/we_menu_runedit">
...
function del(id){
	...
	layer.close(index);
	window.location.href="/slackck_0530/index.php/Admin/We/we_menu_del/we_menu_id/"+id+"";
	});
}
