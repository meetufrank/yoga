...
<script type="text/javascript" src="/yoga/Public/assets/js/region.js"></script>
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="form0" id="form0"  method="post" action="<?php echo U('knows_runadd');?>"  enctype="multipart/form-data">
                                	...
                                	<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="name" id="name"  placeholder=""  class="col-xs-10 col-sm-1"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="tel" id="tel"  placeholder=""  class="col-xs-10 col-sm-3"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="birthday" id="birthday"  placeholder="2016-05-30"  class="col-xs-10 col-sm-2"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="more" id="more"  placeholder="三摩地。。。。等"  class="col-xs-10 col-sm-2"/>
    ...
    <script src="/yoga/Public/ppy/js/fileinput_locale_zh.js" type="text/javascript"></script>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 活动报名简介： </label>
										<div class="col-sm-9">
											<input type="text" name="say" id="news_scontent" class="col-xs-10 col-sm-10"  maxlength="50" />
									...
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 活动报名主内容 </label>
										<div class="col-sm-10">
...
$(function(){
	...
	function checkForm(){
		...
		if( '' == $.trim($('#title').val())){
			layer.alert('活动报名标题不能为空', {icon: 6}, function(index){
 			layer.close(index);
			$('#title').focus();
			});
			return false;
		}
		if(!$('.knows_type').is(':checked')){
			layer.alert('活动报名类型必须选一个', {icon: 6}, function(index){
 			layer.close(index);
			$('.knows_type').focus();
			});
			return false;
		...
		if( '' == $.trim($('#file0').val())){
			layer.alert('你必须上传一个活动报名封面', {icon: 6}, function(index){
 			layer.close(index);
			$('#file0').focus();
			});
			return false;
		...
		if( '' == $.trim($('#news_scontent').val())){
			layer.alert('活动报名简介不能为空', {icon: 6}, function(index){
 			layer.close(index);
			$('#news_scontent').focus();
			});
			return false;
